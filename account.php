...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Account || Prime Mobiles</title>
        ...
        <div class="small-12">
            ...
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  ...
                  echo '<div class="row">';
                  echo '<div class="small-3 columns">';
                  echo '<label for="right-label" class="right inline">Postal Code</label>';
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Update" style="background: #0c7e98; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
