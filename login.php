...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Login || Prime Mobiles</title>
  ...
  <nav class="top-bar" data-topbar role="navigation">
    ...
    <form method="POST" action="verify.php" style="margin-top:200px">
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="Enter Your Email" name="username">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Login" style="background: #0c7e98; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
